const VerticalAlign = ({ styles }: any) => {
  return (
    <svg
      ...
      // style="enable-background:new 0 0 202.624 202.624;"
      // xml:space="preserve"
    >
      <g>
        <g>
          <path
            d="M202.621,97.416h-38.966V58.45c0-2.152-1.743-3.897-3.897-3.897h-38.966c-2.154,0-3.897,1.745-3.897,3.897v38.966H85.724
